...
model = pickle.load(open('/Users/akindoyodavid/Desktop/soil_test/knn.pkl', 'rb'))
...
def predict():
    ...
    if request.method == "POST":
        ...
        return render_template("index.html", image = image, prediction_proba = prediction_proba, prediction = name, crop1 = crop1, crop2 = crop2, crop3 = crop3, crop4 = crop4, crop5 = crop5, crop6 = crop6, crop7 = crop7, crop8 = crop8, crop9 = crop9, crop10 = crop10)
